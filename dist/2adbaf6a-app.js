...
>>>>>>> Add Logs page to the router:dist/2adbaf6a-app.js
      var res;
...
var Logs = (_dec = (0, _mobxReact.inject)('store'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
  ...
  function Logs(props) {
    ...
    _this.getContainerLogs = function (id) {
      _this.logs = _this.containersStore.loadContainersLogs(id);
    };
  ...
  _createClass(Logs, [{
    ...
    key: "render",
    value: function render() {
      var containerId = new URLSearchParams(window.location.search).get('containerId');
